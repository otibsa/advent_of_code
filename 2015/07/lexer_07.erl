...
-file("./lexer_07.erl", 286).
yystate() -> 23.

yystate(26, [83|Ics], Line, Tlen, Action, Alen) ->
...
yystate(25, [10|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line+1, Tlen+1, 8, Tlen);
...
yystate(22, [72|Ics], Line, Tlen, Action, Alen) ->
...
yystate(14, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(12, Ics, Line, Tlen, _, _) ->
    {1,Tlen,Ics,Line};
yystate(11, [72|Ics], Line, Tlen, Action, Alen) ->
...
yystate(1, [68|Ics], Line, Tlen, Action, Alen) ->
...
-file("./lexer_07.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { or_op, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("./lexer_07.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { not_op, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("./lexer_07.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { lshift_op, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./lexer_07.xrl", 13).
yyaction_4(TokenChars, TokenLine) ->
     { token, { rshift_op, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("./lexer_07.xrl", 14).
yyaction_5(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("./lexer_07.xrl", 15).
yyaction_6(TokenChars, TokenLine) ->
     { token, { wire, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("./lexer_07.xrl", 16).
yyaction_7(TokenChars, TokenLine) ->
     { token, { ass_op, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_8/0}).
-file("./lexer_07.xrl", 17).
yyaction_8() ->
     skip_token .
